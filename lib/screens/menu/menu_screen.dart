            ...
            body: IgnorePointer(
                ...
                child: Stack(children: <Widget>[
                  ...
                  Stack(children: <Widget>[
                    ...
                    // IMPRESSUM BUTTON
                    Positioned(
                        right: SizeUtil.getDoubleByDeviceHorizontal(40),
                        top: SizeUtil.getDoubleByDeviceVertical(40),
                        child: IgnorePointer(
                            ignoring: lockScreen,
                            child: Container(
                    ...
                    Positioned(
                      ...
                      child: Center(
                          child: AchievementButtonList(
                              ...
                              animalheight:
                                  SizeUtil.getDoubleByDeviceHorizontal((Constant.achievementButtonSize - 6)))),
                    ),
                    // Stars
                    Positioned(
                    ...
                    Positioned(
                        ...
                        child:
                            IgnorePointer(ignoring: lockScreen, child: SelectedAnimal(size: Constant.menuAnimalSize))),
